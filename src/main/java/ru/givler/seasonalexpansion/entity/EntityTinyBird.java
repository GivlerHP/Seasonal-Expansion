...
import ru.givler.seasonalexpansion.entity.ai.EntityAIBirdFly;

public class EntityTinyBird extends EntityBird {
    ...
    public EntityTinyBird(World par1World) {
        super(par1World);
...
//    }
    ...
    {
        return SeasonalExpansion.ID + ":mob.tinybird.chirp";
    }
    ...
    {
        return SeasonalExpansion.ID + ":mob.tinybird.hurt";
    }
    ...
    protected boolean canDespawn()
    {
        ...
        return this.worldObj.getClosestPlayerToEntity(this, 32.0D) == null;
    }
