...
import ru.givler.seasonalexpansion.entity.ai.EntityRavenLookHelper;

public class EntityRaven  extends EntityTinyBird {

    EntityRavenLookHelper ravenLook = new EntityRavenLookHelper(this);

    public EntityRaven(World par1World) {
        super(par1World);
...
//        this.tasks.addTask(4, new EntityAITFBirdFly(this, 0.25F));
    ...
    {
        return SeasonalExpansion.ID + ":mob.raven.caw";
    }
    ...
    {
        return SeasonalExpansion.ID + ":mob.raven.squawk";
    }
    ...
    public boolean isSpooked() {
        ...
        return this.hurtTime > 0 || (closestPlayer != null &&
                (closestPlayer.inventory.getCurrentItem() == null ||
